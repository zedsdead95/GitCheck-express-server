...
app.get('/check/:username/:repo', (req, res, next) => { // eslint-disable-line no-unused-vars
  client.repoData(req.params.username, req.params.repo)
    .then(data => utils.getData(data))
